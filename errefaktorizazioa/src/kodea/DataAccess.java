...
public class DataAccess {
	...
	public void initializeDB() {
		...
		try {
			...
			// Admin user2 = new Admin("admin", "izena", "abizena", "admin", 26,
			// "asd@gmail.com");
			// Langile user3 = new Langile("langile", "izena", "abizena", "langile", 26,
			// "asd@gmail.com");
	...
	public Question createQuestion(EventQuestion parameterObject, float betMinimum) throws QuestionAlreadyExist {
		System.out.println(">> DataAccess: createQuestion=> event= " + parameterObject.getEvent() + quest
				+ parameterObject.getQuestion() + " betMinimum=" + betMinimum);
	...
	public Quote createQuote(CreateQuoteParameter parameterObject, double mult) {
		System.out.println(">> DataAccess: createQote=> Quote= " + parameterObject.quote + " question= "
				+ parameterObject.question);
		Question quest = db.find(Question.class, parameterObject.question.getQuestionNumber());
		Quote q;
		Integer zenb = -1;
	...
	public boolean existQuestion(Event event, String question) {
		System.out.println(">> DataAccess: existQuestion=> event= " + event + quest + question);
